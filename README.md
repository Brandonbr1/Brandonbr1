...
![github contribution grid snake animation](https://raw.githubusercontent.com/Brandonbr1/Brandonbr1/output/github-contribution-grid-snake.svg)

``` javascript
const ProgramingTools = ["Vscode","Notepad++","IntelliJ IDEA"];

console.log(ProgramingTools);
```

``` terminal 
Vscode,Notepad,IntelliJ IDEA
```
...
<br>
<br>
<img src="https://github-readme-stats.vercel.app/api?username=Brandonbr1" width="400">
<br>
<br>
<br>
<br>
